...
plugins=(brew brew-cask bundler gem git git-flow git-hubflow git-remote-branch gpg-agent history-substring-search extract npm osx pass pod rails ruby sublime tmux vagrant web-search zsh-autosuggestions)
